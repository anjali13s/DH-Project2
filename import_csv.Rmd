...
```{r adding_class}
upper_class_words <- c("king", "bourgeoisie", "wealthy", "rich", "noble", "aristocratic", "elite", "well-off", "blue-blood", "imperial", "posh", "upmarket", "exclusive", "high society", "privileged", "gentry", "mansion" , "prince" , "lady" , "queen" , "sir" , "madam" , "ma'am" )
